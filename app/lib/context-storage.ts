 ...
 *
 * source: https://github.com/sergiodxa/remix-utils/blob/cee1a5d0418909c5b20b3be7cd5719c6adea8652/src/server/middleware/context-storage.ts
...
export namespace unstable_createContextStorageMiddleware {
  export type ReturnType = [
    ...
    () => Omit<unstable_RouterContextProvider, '#private'>,
    () => Request,
  ]
}
