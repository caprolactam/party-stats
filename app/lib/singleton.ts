/**
 *  NOTE: This is forked from `sergiodxa/remix-utils`
 * `remix-utils@^8.8.0`現在では`zod@^3.22.4`が使用されていて依存関係が競合するためイントールできません。
 *
 * source: https://github.com/sergiodxa/remix-utils/blob/cee1a5d0418909c5b20b3be7cd5719c6adea8652/src/server/middleware/singleton.ts
 * MIT license: https://github.com/sergiodxa/remix-utils/blob/cee1a5d0418909c5b20b3be7cd5719c6adea8652/LICENSE
 *
...
type unstable_MiddlewareGetter<T> = (
  context: Omit<unstable_RouterContextProvider, '#private'>,
) => T
...
export namespace unstable_createSingletonMiddleware {
  export interface Options<T> {
    instantiator(request: Request, context: Omit<unstable_RouterContextProvider, '#private'>): T
  }
